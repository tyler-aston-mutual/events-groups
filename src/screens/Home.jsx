...
export const ALL_ITEMS = [
  ...
  },
  {
    ...
    location: 'The Roof, Salt Lake City',
    going: 8,
    description: 'Looking for a fun Friday night out? Come join us for a laid-back evening of good music, great people, and the perfect chance to meet someone new.',
  ...
  },
  {
    ...
    location: 'Flanker Kitchen, Salt Lake City',
    going: 10,
    description: "Team trivia night! We'll form teams of 4-5 and compete for bragging rights. Topics range from pop culture to church history. No trivia experience required — just bring your brain.",
    ...
    <div style={{
      ...
      >
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
          stroke="rgba(0,0,0,0.75)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function IconButton({ colors, icon, onClick, badge, variant }) {
  ...
  return (
    <button onClick={onClick} style={{
      ...
      color: isAccent ? colors.grey1000 : 'inherit',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
      cursor: 'pointer',
...
function GroupToggleIcon({ color }) {
  return (
    <svg width="15" height="13" viewBox="0 0 22 18" fill="none">
      ...
      {/* Left person (in front, slightly larger) */}
...
function GroupCreateIcon({ color }) {
  return (
    <svg width="20" height="20" viewBox="0 0 26 22" fill="none">
      ...
      {/* Left person (in front) */}
      <circle cx="9.5" cy="5" r="3.2" fill={color} />
      <path d="M9.5 9.5c-3 0-5.5 2-5.5 5h11c0-3-2.5-5-5.5-5z" fill={color} />
      {/* Plus badge */}
      <circle cx="21" cy="17" r="4.5" fill={color} stroke={color} />
      <line x1="21" y1="14.8" x2="21" y2="19.2" stroke="white" strokeWidth="1.75" strokeLinecap="round"/>
      <line x1="18.8" y1="17" x2="23.2" y2="17" stroke="white" strokeWidth="1.75" strokeLinecap="round"/>
    </svg>
  )
}
