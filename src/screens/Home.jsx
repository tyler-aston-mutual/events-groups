            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '7px 14px',
                  borderRadius: 20,
                  border: active ? `2px solid ${tab.activeColor}` : `2px solid ${colors.grey200}`,
                  backgroundColor: active ? (tab.activeColor === colors.grey1000 ? `${colors.grey1000}0A` : `${tab.activeColor}14`) : colors.grey50,
                  cursor: 'pointer',
                  fontSize: 13,
                  fontWeight: active ? 600 : 500,
                  color: active ? tab.activeColor : colors.grey500,
