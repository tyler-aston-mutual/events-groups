    ...
    <div style={{
      ...
      <div style={{ display: 'flex', padding: 12, gap: 12, alignItems: 'center' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          ...
          {/* Attendance */}
          {going > 0 && (
            <InfoRow icon={<HeartCardIcon color={colors.grey400} />} color={colors.grey600}>
...
// Two-person solid group icon — left person in front, right behind
